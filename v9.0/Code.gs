...
function initializeSheets_() {
  ...
  const defaults = {
    ...
    "Datasheet": {
      data: [
        [ "To Send", "Done?", "Email Address to Send", "Template", "Attachment List", "Subfolder", "UserID", "UserName", "X1", "X2", "X3", "imgfile1", "imglink1", "qrdata1"],
        [ "Yes", "", currentUser, "Template1", "", "", "1001", "Alice Chan", "Physics", "Chemistry", "Biology", "sunset1.jpg", "https://raw.githubusercontent.com/charlotte-lau-hk/test/master/sunset2.jpg", "https://github.com/charlotte-lau-hk"],
